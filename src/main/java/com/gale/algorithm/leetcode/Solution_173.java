 ...
 * 进阶：
 * <ul>
 *     <li>你可以设计一个满足下述条件的解决方案吗？next() 和 hasNext() 操作均摊时间复杂度为 O(1) ，并使用 O(h) 内存。其中 h 是树的高度。</li>
 * </ul>
...
class BSTIterator {
    private final LinkedList<TreeNode> inorder;
